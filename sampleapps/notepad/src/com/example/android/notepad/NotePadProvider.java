...
public class NotePadProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues initialValues) {
        ...
        if (values.containsKey(NotePad.Notes.IS_ENCRYPTED) == false) {
            values.put(NotePad.Notes.IS_ENCRYPTED, 0);
        }
    ...
    static {
        ...
        sNotesProjectionMap.put(Notes.IS_ENCRYPTED, Notes.IS_ENCRYPTED);
